...
import com.taskmanagerbackend.model.User;
import com.taskmanagerbackend.repository.UserRepository;
...
public class UserService {
    ...
    public String loginOAuthGoogle(Token token) {
        User user = verifyIDToken(token.getIdToken());
        if (user == null) {
